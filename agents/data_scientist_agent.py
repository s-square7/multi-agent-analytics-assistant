...
from function_tools.scientist_tools import get_scientist_tools
...
def build_data_scientist_agent(
    ...
    """Build the Data Scientist Agent with scientist function tools (+ optional MCP tools)."""
    tools = list(get_scientist_tools())
    if extra_tools:
